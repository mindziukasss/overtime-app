...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      other_user = User.create(first_name: "Non", last_name: "Auto", email: "non@asdf.com", password: "asdfasdf", 
  ...
  describe 'creation' do
    ...
    it 'will have a user associated id' do
      fill_in 'post[date]', with: Date.today
  ...
  describe 'edit' do 
      before do
      @edit_user = User.create(first_name: "asdf", last_name: "asdf", email: "asdf@asdf.com", password: "asdfasdf", 
        password_confirmation: "asdfasdf")
    ...
    it 'cannot be eited bu a non authorized user' do 
      logout(:user)
